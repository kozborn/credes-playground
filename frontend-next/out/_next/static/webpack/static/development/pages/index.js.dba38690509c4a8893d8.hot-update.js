...
var Header = function Header() {
  ...
  var menuClassNames = classnames__WEBPACK_IMPORTED_MODULE_2___default()("header-menu flex-grow-0 lg:flex lg:items-center", {
    block: visible,
    shadow: visible,
    hidden: !visible
  });
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("nav", {
    className: "block lg:flex flex-grow-0 lg:justify-center lg:items-center bg-white p-6 mb-6 lg:shadow",
    ref: menuNode,
    __source: {
    ...
    className: "flex lg:hidden flex-row-reverse",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 41
    },
...
//# sourceMappingURL=index.js.dba38690509c4a8893d8.hot-update.js.map